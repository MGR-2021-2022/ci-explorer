...
def print_result(label: str, result: object) -> None:
    print(label + "-> minutes: " + str(result[label]["reaction_time"]) + " | commits: " + str(result[label]["commit_count"]) + " | average: " + str(result[label]["reaction_time"]/result[label]["commit_count"]))
